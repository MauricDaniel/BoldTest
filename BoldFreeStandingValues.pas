...
type
  ...
  protected
    ...
    procedure SetAsBytes(const NewValue: TBytes);
  public
...
function TBFSBlobAbstract.GetAsBytes: TBytes;
begin
  result := fDataValue;
end;

procedure TBFSBlobAbstract.SetAsBytes(const NewValue: TBytes);
begin
  fDataValue := NewValue;
  SetToNonNull;
end;
...
begin
  Result := inherited IsEqualToValue(Value) and
      ...
      (AsBytes = aBlobValue.AsBytes) and
