...
type
  ...
  ['{F4126F4C-F1B2-472B-B53F-2ECEC8EE9253}']
    ...
    procedure SetAsBytes(const Value: TBoldBlobData);
...
function TBoldFieldWrapper.GetAsBytes: TBoldBlobData;
begin
  result := Field.AsBytes;
end;
...
procedure TBoldFieldWrapper.SetAsBytes(const Value: TBoldBlobData);
begin
  Field.AsBytes := Value;
end;
