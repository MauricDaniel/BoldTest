...
//    procedure AddGuard(Vars: array of TObject);
    procedure AddGuard(var vx); overload;
    procedure AddObject(var vObject: TObject); overload;
  end;
...
procedure TBoldGuard.AddGuard(var vx);
begin
  fObjectVariable[fUsed] := @TObject(vx);
  Tobject(vx) := nil;
  inc(fUsed);
end;

procedure TBoldGuard.AddObject(var vObject: TObject);
begin
  fObjectVariable[fUsed] := @vObject;
  inc(fUsed);
end;
