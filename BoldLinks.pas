...
type
  TBoldObjectIdHashIndex = class(TBoldObjectHashIndex)
  protected
    function ItemAsKeyObject(Item: TObject): TObject; override;
  end;

function TBoldObjectIdHashIndex.ItemAsKeyObject(Item: TObject): TObject;
begin
  Result := Item; // TBoldObjectId treated as TObject
end;
...
var
  ...
  NewListIndex: TBoldObjectIdHashIndex;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          NewListIndex.Remove(NewListOfOtherEnd[I]); // Keep index in sync
        end;
      end;
    end;
    ...
    begin
      ...
      begin
        ...
        NewListIndex.Add(BoldObject.BoldObjectLocator.BoldObjectID);
      end;
    end;
  end;
...
var
  ...
  G: IBoldGuard;
begin
  G := TBoldGuard.Create(NewListOfOtherEnd, NewListIndex);
  ...
  NewListIndex := TBoldObjectIdHashIndex.Create;
  for I := 0 to NewListOfOtherEnd.Count - 1 do
    NewListIndex.Add(NewListOfOtherEnd[I]);
  ...
  begin
    ...
    if not Assigned(NewListIndex.FindByObject(OldLocator.BoldObjectId)) then
    begin
