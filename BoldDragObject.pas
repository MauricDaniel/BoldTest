...
type
  ...
  private
    function GetControlProviders(index: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}): TBoldControlProvider;
  public
    destructor Destroy; override;
    procedure Add(ControlProvider: TBoldControlProvider);
    property Items[index: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}]: TBoldControlProvider read GetControlProviders;
...
function TBoldControlProviderList.GetControlProviders(index: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}): TBoldControlProvider;
begin
