...
const
  DefaultMappings: array[0..35, 0..12] of String = (
  ...
  ('UnicodeString', 'UnicodeString','TBA<Name>',   'UnicodeString',  'TBoldPM<Name>',   'AsString',   'String',    'BoldAttributes',   'WideString', 'BSTR',     'IBoldUnicodeStringContent', 'AsUnicodeString', 'String'),
  ...
  ('UnicodeText',   'UnicodeText',  'TBA<Name>',   'UnicodeString',  'TBoldPM<Name>',   'AsString',   'String',    'BoldAttributes',   'WideString', 'BSTR',     'IBoldUnicodeStringContent', 'AsUnicodeString', 'String'),
  ...
  ('BinaryBlob',    'BinaryBlob',   'TBA<Name>',   'TBytes',         'TBoldPMBlob',     'AsBytes',    'TBytes',    'BoldAttributes',   'TBytes',     'BSTR',     'IBoldBlobContent',    'AsBlob', 'String'),
  ...
  ('AnsiBlob',      'AnsiBlob',     'TBA<Name>',   '<Name>',         'TBoldPMBlob',     'AsString',   'String',    'BoldAttributes',   'WideString', 'BSTR',     'IBoldBlobContent',    'AsBlob', 'String'),
  ('UnicodeBlob',   'UnicodeBlob',  'TBA<Name>',   '<Name>',         'TBoldPMBlob',     'AsString',   'String',    'BoldAttributes',   'WideString', 'BSTR',     'IBoldBlobContent',    'AsBlob', 'String'),
