...
type
  ...
  public
    ...
    procedure ReadDataFromDB(const DataBase: IBoldDataBase; ReadDbTypeFromDB, ReadMappingFromDB: Boolean); virtual; abstract;
    procedure WriteDataToDB(const DataBase: IBoldDataBase);
...
procedure TBoldSQLMappingInfo.WriteDataToDB(const DataBase: IBoldDataBase);
var
  i: integer;
  q: IBoldExecQuery;
  Script: TStringList;
