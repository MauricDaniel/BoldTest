...
type
  ...
  public
    procedure ReadDataFromDB(const DataBase: IBoldDataBase; ReadDbTypeFromDB, ReadMappingFromDB: Boolean); override;
    procedure ScriptForWriteData(const DataBase: IBoldDataBase; Script: TStrings; ClearFirst: Boolean;
...
procedure TBoldDefaultMappingInfo.ReadDataFromDB(const DataBase: IBoldDataBase; ReadDbTypeFromDB, ReadMappingFromDB: Boolean);
const
...
procedure TBoldDefaultMappingInfo.ScriptForWriteData(const DataBase: IBoldDataBase;
