...
type
  ...
  private
    function GetItems(index: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}): TBoldTemplateHolder;
  public
    property items[index: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}]: TBoldTemplateHolder read GetItems; default;
  end;
...
function TBoldTemplateList.GetItems(index: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}): TBoldTemplateHolder;
begin
