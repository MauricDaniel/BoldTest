...
begin
  ...
  begin
    ...
    PInfo^.OutQ := OutQ;
    if Assigned(PropagatorMainForm) then
      PostMessage(PropagatorMainForm.Handle, BM_UPDATE_CLIENT_INFO, 0, NativeInt(PInfo));
  end;
end;
...
begin
  ...
  begin
    ...
    PInfo^.Sent := Sent;
    if Assigned(PropagatorMainForm) then
      PostMessage(PropagatorMainForm.Handle, BM_UPDATE_GLOBAL_INFO, 0, NativeInt(PInfo));
  end;
end;
