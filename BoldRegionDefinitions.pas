...
type
  ...
  private
    function GetItem(i: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}): TBoldConcreteRegionDefinition;
    function GetAsCommaText: string;
  public
    function FindByRootClass(RootClass: TBoldClassTypeInfo): TBoldConcreteRegionDefinition;
    property Items[i: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}]: TBoldConcreteRegionDefinition read GetItem; default;
  public
  ...
  private
    function GetItem(i: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}): TBoldSubregionReference;
    function GetAsCommaText: string;
  public
    property Items[i: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}]: TBoldSubregionReference read GetItem; default;
    property AsCommaText: string read GetAsCommaText;
  end;

  TBoldRegionElementInclusionList = class(TList)
  private
    function GetItem(i: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}): TBoldRegionElementInclusion;
    function GetAsCommaText: string;
  public
    property Items[i: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}]: TBoldRegionElementInclusion read GetItem; default;
    property AsCommaText: string read GetAsCommaText;
  end;
...
function TBoldConcreteRegionDefinitionList.GetItem(i: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}): TBoldConcreteRegionDefinition;
begin
...
function TBoldRegionElementInclusionList.GetItem(i: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}): TBoldRegionElementInclusion;
begin
...
function TBoldSubregionReferenceList.GetItem(i: {$IFDEF BOLD_DELPHI29_OR_LATER}NativeInt{$ELSE}Integer{$ENDIF}): TBoldSubregionReference;
begin
...
begin
  ...
  begin
    systemTypeInfo := fConcreteDefinitions.GetItem(0).RootClass.SystemTypeInfo;
