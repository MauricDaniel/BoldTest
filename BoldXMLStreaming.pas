...
begin
  ...
  begin
    DataString := TNetEncoding.Base64.Encode(Value);
...
begin
  ...
  begin
    result := TNetEncoding.Base64.Decode(DataString)
  end else
    result := DataString;
end;
...
procedure TBoldXMLNode.WriteSubNodeData(const Accessor: string; const Value: String);
var
  aSubNode: TBoldXMLNode;
begin
  aSubNode := NewSubNode(Accessor);
